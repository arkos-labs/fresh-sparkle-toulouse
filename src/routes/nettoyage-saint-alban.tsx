...
export const Route = createFileRoute("/nettoyage-saint-alban")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-saint-alban` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-saint-alban` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-saint-alban` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-saint-alban`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Saint-Alban, nous proposons des prestations d'entretien à domicile pour vos canapés, matelas, tapis et véhicules. Commune résidentielle du nord toulouse.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              <li><strong>Nettoyage de canapés et fauteuils :</strong> Tissu, cuir ou velours — y compris canapés convertibles avec matelas intégré.</li>
            ...
            <p>Saint-Alban est dans notre circuit nord. Nos techniciens formés y interviennent avec leurs machines haute puissance, sans frais de déplacement supplémentaire.</p>
            <p>Devis gratuit sous 24h, tarifs affichés, produits certifiés Écolabel. Résultat garanti.</p>
