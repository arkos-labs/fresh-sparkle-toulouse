...
export const Route = createFileRoute("/nettoyage-saint-jean")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-saint-jean` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-saint-jean` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-saint-jean` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-saint-jean`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Saint-Jean, nous proposons des prestations d'entretien à domicile pour vos canapés, matelas, tapis et véhicules dans ce secteur nord de Toulouse.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              <li><strong>Nettoyage de canapés et fauteuils :</strong> Tissu, cuir ou velours — traitement des taches, anti-odeur et hydratation du cuir.</li>
            ...
            <p>Saint-Jean est dans notre zone nord. Nos techniciens y interviennent avec leur matériel complet, sans frais de déplacement supplémentaire.</p>
            <p>Nous nettoyons et hydratons également les canapés en cuir avec des produits dédiés : cuir propre, souple et protégé.</p>
