...
export const Route = createFileRoute("/nettoyage-eaunes")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-eaunes` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-eaunes` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-eaunes` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-eaunes`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Eaunes, nous proposons des prestations d'entretien à domicile pour vos textiles et véhicules. Commune du sud toulousain, entre Muret et Toulouse.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              <li><strong>Nettoyage de canapés et fauteuils :</strong> Tissu, cuir ou velours : traitement des taches et anti-odeur.</li>
            ...
            <p>Nos équipes interviennent à Eaunes sur demande dans notre secteur sud. Pour un créneau standard, 24 à 48h suffisent ; pour une urgence, appelez-nous directement.</p>
            <p>Contactez-nous pour confirmer votre adresse et obtenir un devis gratuit.</p>
