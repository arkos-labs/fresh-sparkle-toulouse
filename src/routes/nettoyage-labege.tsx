...
export const Route = createFileRoute("/nettoyage-labege")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-labege` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-labege` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-labege` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-labege`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Labège, nous proposons des prestations à domicile pour les particuliers et les professionnels de ce pôle tertiaire du Sicoval. Canapés, matelas, tapis, moquettes de bureau.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Tapis et moquettes de bureau :</strong> Shampouinage professionnel pour les particuliers et les entreprises du Sicoval.</li>
              <li><strong>Nettoyage automobile :</strong> Lavage intérieur complet à domicile ou sur parking de bureau.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Labège est dans notre zone régulière. Nous intervenons pour les particuliers comme pour les entreprises : nettoyage de moquettes de bureau, sièges de réunion et vitrerie.</p>
            <p>Contrats d'entretien professionnel disponibles sur devis. Particuliers : devis gratuit sous 24h.</p>
