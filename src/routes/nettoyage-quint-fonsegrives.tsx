...
export const Route = createFileRoute("/nettoyage-quint-fonsegrives")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-quint-fonsegrives` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-quint-fonsegrives` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-quint-fonsegrives` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-quint-fonsegrives`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Quint-Fonsegrives, nous proposons des prestations à domicile pour vos canapés, matelas, tapis et vitrerie. Commune résidentielle des coteaux de l'est toulousain.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Nettoyage de vitrerie :</strong> Vitres à l'eau osmosée pour un résultat sans traces ni coulures.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Quint-Fonsegrives est dans notre zone régulière. Nos techniciens y interviennent avec discrétion et professionnalisme, sans frais de déplacement supplémentaire.</p>
            <p>Produits certifiés Écolabel, tarifs affichés. Devis gratuit sous 24h.</p>
