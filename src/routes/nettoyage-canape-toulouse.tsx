...
export const Route = createFileRoute("/nettoyage-canape-toulouse")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://cleanfresh-toulouse.fr/nettoyage-canape-toulouse" },
    ...
    links: [{ rel: "canonical", href: "https://cleanfresh-toulouse.fr/nettoyage-canape-toulouse" }],
  }),
