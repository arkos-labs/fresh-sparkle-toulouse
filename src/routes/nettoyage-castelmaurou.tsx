...
export const Route = createFileRoute("/nettoyage-castelmaurou")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-castelmaurou` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-castelmaurou` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-castelmaurou` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-castelmaurou`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Castelmaurou, nous proposons des prestations d'entretien à domicile pour vos canapés, matelas, tapis et terrasses. Commune résidentielle des coteaux est toulousains.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Nettoyage de terrasses :</strong> Nettoyage haute pression de vos dalles, carrelage et bois extérieur.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Castelmaurou est dans notre zone régulière. Nos techniciens y interviennent avec leur matériel complet, sans frais de déplacement supplémentaire.</p>
            <p>Notre service nettoyage de terrasse haute pression est idéal pour les maisons individuelles avec dalles, carrelage ou bois extérieur. Devis gratuit sous 24h.</p>
