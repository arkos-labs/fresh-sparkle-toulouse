...
export const Route = createFileRoute("/nettoyage-leguevin")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-leguevin` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-leguevin` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-leguevin` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-leguevin`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Léguevin, nous nous déplaçons chez vous avec notre matériel professionnel pour vos canapés, matelas, tapis et véhicules. Commune du Savès à l'ouest de Toulouse.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Tapis et moquettes :</strong> Shampouinage professionnel, séchage rapide grâce à notre extraction haute puissance.</li>
            ...
            <p>Nos techniciens se déplacent à Léguevin avec tout l'équipement nécessaire. Séchage rapide garanti en 2 à 4h pour que vous profitiez de votre intérieur le jour même.</p>
            <p>Devis gratuit sous 24h. Contactez-nous pour confirmer votre adresse.</p>
