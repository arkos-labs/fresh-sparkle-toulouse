...
export const Route = createFileRoute("/nettoyage-terrasse-toulouse")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://cleanfresh-toulouse.fr/nettoyage-terrasse-toulouse" },
    ...
    links: [{ rel: "canonical", href: "https://cleanfresh-toulouse.fr/nettoyage-terrasse-toulouse" }],
  }),
