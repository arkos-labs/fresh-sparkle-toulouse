...
const CITY = "Toulouse";
const TITLE = `Nettoyage à Toulouse — canapé, matelas, tapis à domicile | Clean&Fresh`;
const DESC = `Nettoyage canapé, matelas, tapis et auto à Toulouse dès 49 €. Déplacement à domicile, produits Écolabel, résultat garanti. Devis gratuit sous 24h.`;

export const Route = createFileRoute("/nettoyage-toulouse")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-toulouse` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-toulouse` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-toulouse` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-toulouse`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant dans tous les quartiers de Toulouse, nous proposons des services d'entretien sur-mesure pour vos intérieurs, véhicules et locaux. Nos techniciens se déploient avec le matériel professionnel pour un résultat optimal.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              <li><strong>Nettoyage de canapés et fauteuils :</strong> Canapé tissu, cuir ou velours : traitement des taches, ravivement des couleurs et anti-odeur par injection-extraction.</li>
              <li><strong>Entretien de matelas :</strong> Désinfection approfondie, traitement anti-acariens et élimination des auréoles.</li>
              <li><strong>Shampouinage de tapis et moquettes :</strong> Nettoyage recto-verso et extraction des salissures au cœur des fibres.</li>
              <li><strong>Nettoyage automobile à domicile :</strong> Lavage intérieur complet de votre véhicule directement chez vous à Toulouse.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Toulouse est notre ville principale. Présents au quotidien sur le terrain, nous connaissons parfaitement les accès et spécificités de chaque quartier — du Capitole aux Minimes, de Rangueil à Borderouge.</p>
            <p>Faire appel à Clean&Fresh, c'est choisir la transparence et l'efficacité : tarifs affichés, devis gratuit sous 24h, produits certifiés Écolabel et séchage rapide garanti en 2 à 4h.</p>
