...
export const Route = createFileRoute("/nettoyage-aussonne")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-aussonne` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-aussonne` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-aussonne` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-aussonne`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Aussonne, nous nous déplaçons chez vous avec notre matériel professionnel pour vos canapés, matelas, tapis et véhicules. Village du nord-ouest toulousain.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Tapis et moquettes :</strong> Shampouinage professionnel — laine, berbère, synthétique — séchage rapide.</li>
              <li><strong>Nettoyage automobile :</strong> Lavage intérieur complet à domicile.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Nous intervenons à Aussonne avec le même soin qu'à Toulouse. Notre procédé injection-extraction est adapté à tous les types de fibres, y compris la laine et les tapis berbères.</p>
            <p>Contactez-nous pour confirmer votre adresse et recevoir un devis gratuit sous 24h.</p>
