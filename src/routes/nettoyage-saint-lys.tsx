...
export const Route = createFileRoute("/nettoyage-saint-lys")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-saint-lys` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-saint-lys` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-saint-lys` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-saint-lys`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Saint-Lys, nous nous déplaçons chez vous avec notre matériel professionnel pour vos canapés, matelas, tapis et véhicules. Commune du Savès à l'ouest de Toulouse.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <p>Nos techniciens apportent tout l'équipement à Saint-Lys. Un léger supplément de déplacement peut s'appliquer — contactez-nous pour un devis précis et gratuit.</p>
            <p>Tarifs affichés, produits certifiés Écolabel. Résultat garanti, séchage en 2 à 4h.</p>
