...
export const Route = createFileRoute("/nettoyage-castelginest")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-castelginest` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-castelginest` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-castelginest` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-castelginest`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Castelginest, nous nous déplaçons chez vous pour redonner vie à vos canapés, matelas, tapis et véhicules grâce à notre matériel professionnel.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <p>Castelginest est dans notre secteur nord. Nos techniciens formés y interviennent régulièrement avec leur équipement complet.</p>
            <p>Produits certifiés Écolabel, tarifs affichés, devis gratuit sous 24h. Résultat garanti.</p>
