...
export const Route = createFileRoute("/nettoyage-plaisance-du-touch")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-plaisance-du-touch` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-plaisance-du-touch` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-plaisance-du-touch` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-plaisance-du-touch`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Plaisance-du-Touch, nous proposons des prestations d'entretien à domicile pour vos intérieurs et véhicules. Déplacement inclus dans notre zone ouest.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              <li><strong>Nettoyage de canapés et fauteuils :</strong> Tissu, cuir ou velours : traitement des taches, odeurs et ravivement des couleurs.</li>
              <li><strong>Entretien de matelas :</strong> Désinfection approfondie, anti-acariens et élimination des auréoles.</li>
              <li><strong>Tapis et moquettes :</strong> Shampouinage professionnel par injection-extraction, séchage rapide.</li>
            ...
            <p>Plaisance-du-Touch est desservie régulièrement dans notre secteur ouest toulousain. Nos techniciens se déplacent avec tout le matériel nécessaire.</p>
            <p>Produits certifiés Écolabel, sûrs pour vos enfants et vos animaux. Devis gratuit sous 24h.</p>
