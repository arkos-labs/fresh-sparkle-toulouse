...
export const Route = createFileRoute("/nettoyage-seysses")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-seysses` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-seysses` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-seysses` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-seysses`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Seysses, nous proposons des prestations d'entretien à domicile pour vos textiles et véhicules dans ce secteur sud de Toulouse.
          </p>
      ...
      <FadeIn delay={0.1}>
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <p>Nos équipes interviennent à Seysses sur demande, avec le même soin qu'à Toulouse. Créneaux disponibles du lundi au samedi de 8h à 21h.</p>
            <p>Contactez-nous pour confirmer votre adresse et obtenir un devis gratuit sous 24h.</p>
