...
export const Route = createFileRoute("/nettoyage-portet-sur-garonne")({
  head: () => ({
    meta: [
      { title: TITLE },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-portet-sur-garonne` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-portet-sur-garonne`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Portet-sur-Garonne, nous nous déplaçons chez vous avec notre matériel professionnel pour un nettoyage en profondeur de vos textiles et véhicules.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Nettoyage automobile :</strong> Sièges, tapis, tableau de bord, vitres — lavage intérieur complet à domicile.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Portet-sur-Garonne est dans notre zone d'intervention régulière. Nos techniciens formés y interviennent avec leurs machines haute puissance, sans frais de déplacement supplémentaire.</p>
            <p>Transparence des tarifs, devis gratuit sous 24h, produits certifiés Écolabel. Séchage rapide en 2 à 4h.</p>
