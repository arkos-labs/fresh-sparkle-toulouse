      ...
      >
        ...
        <div className="relative flex-1 flex items-center">
          <div className="mx-auto w-full max-w-6xl px-4 py-4 md:py-8 lg:py-12 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="hidden lg:block shrink-0 lg:ml-auto">
              <div className="flex items-center gap-3 bg-white w-max px-4 py-2.5 rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300">
