...
export const Route = createFileRoute("/nettoyage-extreme-toulouse")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://cleanfresh-toulouse.fr/nettoyage-extreme-toulouse" },
    ...
    links: [{ rel: "canonical", href: "https://cleanfresh-toulouse.fr/nettoyage-extreme-toulouse" }],
  }),
