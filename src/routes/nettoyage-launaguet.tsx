...
export const Route = createFileRoute("/nettoyage-launaguet")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-launaguet` },
      { name: "twitter:title", content: TITLE },
      { name: "twitter:description", content: DESC },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-launaguet` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-launaguet` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-launaguet`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Launaguet, nous proposons des prestations d'entretien à domicile pour vos textiles et véhicules dans ce secteur nord de Toulouse.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Tapis et moquettes :</strong> Shampouinage professionnel recto-verso, extraction des salissures, séchage rapide.</li>
              <li><strong>Nettoyage automobile :</strong> Sièges, tapis, vitres — lavage intérieur complet à domicile.</li>
            </ul>

            <h2>Pourquoi faire appel à notre entreprise ?</h2>
            <p>Launaguet est desservie régulièrement dans notre circuit nord. Nos techniciens apportent tout l'équipement nécessaire — vous n'avez rien à préparer.</p>
            <p>Tarifs affichés, devis gratuit sous 24h, produits Écolabel. Service détachage intensif disponible pour les taches résistantes.</p>
