...
export const Route = createFileRoute("/nettoyage-roques")({
  head: () => ({
    meta: [
      { title: TITLE },
      ...
      { property: "og:url", content: `${SITE_URL}/nettoyage-roques` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/nettoyage-roques` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: `Nettoyage ${CITY}`, item: `https://cleanetfresh.fr/nettoyage-roques` },
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "Clean&Fresh",
          url: `https://cleanetfresh.fr/nettoyage-roques`,
      ...
      <section className="relative overflow-hidden bg-hero-gradient text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 md:py-20 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-ink-foreground/80 md:mt-5 md:text-base">
            Entreprise de nettoyage intervenant à Roques, nous nous déplaçons chez vous avec notre matériel professionnel pour vos canapés, matelas, tapis et véhicules. Commune du sud toulousain sur la Garonne.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16">
          <div className="prose prose-sm md:prose-base max-w-none text-muted-foreground [&>p]:mb-5 [&>ul]:mb-5 [&>h2]:mt-10 [&>h2]:mb-4">
            ...
            <ul>
              ...
              <li><strong>Tapis et moquettes :</strong> Shampouinage professionnel recto-verso, séchage rapide.</li>
            ...
            <p>Nous intervenons à Roques dans notre secteur sud. Notre option nettoyage recto-verso (+25 €) permet un résultat total des deux côtés du tapis.</p>
