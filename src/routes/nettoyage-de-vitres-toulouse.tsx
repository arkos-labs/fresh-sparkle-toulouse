...
export const Route = createFileRoute("/nettoyage-de-vitres-toulouse")({
  head: () => ({
    meta: [
      { title: "Nettoyage vitres Toulouse \u2014 soigné | Clean&Fresh" },
      ...
      { property: "og:title", content: "Nettoyage vitres Toulouse \u2014 soigné | Clean&Fresh" },
      ...
      { property: "og:url", content: "https://cleanetfresh.fr/nettoyage-de-vitres-toulouse" },
    ...
    links: [{ rel: "canonical", href: "https://cleanetfresh.fr/nettoyage-de-vitres-toulouse" }],
  }),
